...
export default function SeedInterviewData({
  onDone
}) {
  const {
    t
  ...
  return <div className="card p-8 text-center">
      ...
      <div className="text-label-md font-label-md text-on-background mb-2">{t("SeedInterviewData.no_interview_sessions_yet")}</div>
      <div className="text-body-sm font-body-sm text-surface-variant mb-6">{t("SeedInterviewData.seed_4_sample_interview")}</div>
