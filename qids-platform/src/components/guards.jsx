...
export function RoleRoute({ roles, children }) {
  ...
  return <Navigate to="/app/dashboard" replace state={{ denied: location.pathname }} />;
}
 ...
 */
export function EntitlementRoute({ entitlement, feature, children }) {
  const { userProfile } = useAuth();
...
function LockedPanel({ feature, plan }) {
  return (
    <div className="page-pad max-w-[560px] mx-auto animate-fade">
      <div className="border-[0.5px] border-outline-variant bg-surface-container-low p-10 text-center">
        ...
        <div className="text-technical-sm font-technical-sm text-muted-foreground uppercase tracking-[0.2em] mb-3">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          <Link to="/mode" className="btn-primary">View plans</Link>
