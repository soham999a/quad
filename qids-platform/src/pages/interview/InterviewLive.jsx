  ...
  return (
    <div className="page-pad max-w-[960px] mx-auto animate-fade">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="kicker mb-2">Live Interview</div>
      ...
      <div className="mb-8">
        <div className="h-1 bg-surface-container-high overflow-hidden">
          <div
            ...
            style={{ width: `${(questionIdx / totalQuestions) * 100}%` }}
          />
        </div>
      </div>
      ...
      {currentQuestion && (
        <div className="card p-6 md:p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            {currentDim && (
              <span className="text-technical-sm font-technical-sm text-primary">{currentDim.label}</span>
            )}
          </div>
          ...
          {currentQuestion.context && (
            <div className="text-body-sm font-body-sm text-surface-variant italic mb-6">
              {currentQuestion.context}
            </div>
          )}
          ...
          {/* Score Buttons */}
          <div className="mb-6">
            <div className="text-technical-sm font-technical-sm text-surface-variant uppercase tracking-widest mb-3">Rating</div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={e => handleNotes(currentQuestion.id, e.target.value)}
              placeholder="Observations about the candidate's response..."
              rows={2}
          ...
          {currentQuestion.followUp && (
            <div className="mt-4 bg-surface-container-low p-3 border-[0.5px] border-outline-variant">
              <div className="text-technical-sm font-technical-sm text-surface-variant">Follow-up: {currentQuestion.followUp}</div>
            </div>
          )}
        </div>
      )}
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setQuestionIdx(Math.min(totalQuestions - 1, questionIdx + 1))}
